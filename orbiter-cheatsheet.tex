...
\begin{minipage}[t]{64mm}
\sectiontitle{MFD}
\command{Shift + F1}{left/right MFD menu}
\command{Shift + Esc}{left/right MFD on/off}
...
\begin{footnotesize}
  \url{http://orbit.medphys.ucl.ac.uk/download/orbiter.pdf}\smallskip\\
  \url{http://orbiter.dansteph.com/forum/index.php?page=download}\smallskip\\
  \url{http://www.orbithangar.com/}\smallskip\\
  \url{http://www.alteaaerospace.com/}\smallskip\\
  \url{https://www.orbiter-forum.com/}\smallskip\\
\end{footnotesize}
...
\url{https://github.com/wedesoft/orbiter-cheat}\\
}
